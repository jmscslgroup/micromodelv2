...
// C/C++ source code generated on : Tue Jul 20 12:18:25 2021
//
...
struct B_micromodelv2_T {
  SL_Bus_micromodelv2_geometry_msgs_Twist In1;// '<S19>/In1'
  SL_Bus_micromodelv2_geometry_msgs_Twist In1_p;// '<S18>/In1'
  ...
  real_T bsum;
  real_T value;
  SL_Bus_micromodelv2_std_msgs_Float64 In1_n;// '<S17>/In1'
...
struct DW_micromodelv2_T {
  ...
  ros_slroscpp_internal_block_P_T obj_ek;// '<S16>/SinkBlock'
  ros_slroscpp_internal_block_P_T obj_b;// '<S14>/SinkBlock'
  ...
  ros_slroscpp_internal_block_S_T obj_cg;// '<S12>/SourceBlock'
  ros_slroscpp_internal_block_S_T obj_d;// '<S11>/SourceBlock'
  ros_slroscpp_internal_block_S_T obj_m;// '<S10>/SourceBlock'
...
//  '<S4>'   : 'micromodelv2/MATLAB Function1'
//  '<S5>'   : 'micromodelv2/Publish'
//  '<S6>'   : 'micromodelv2/Publish1'
//  '<S7>'   : 'micromodelv2/Publish2'
//  '<S8>'   : 'micromodelv2/Publisher'
//  '<S9>'   : 'micromodelv2/Publisher1'
//  '<S10>'  : 'micromodelv2/Subscribe'
//  '<S11>'  : 'micromodelv2/Subscribe2'
//  '<S12>'  : 'micromodelv2/Subscribe3'
//  '<S13>'  : 'micromodelv2/Publisher/Blank Message3'
//  '<S14>'  : 'micromodelv2/Publisher/Publish3'
//  '<S15>'  : 'micromodelv2/Publisher1/Blank Message3'
//  '<S16>'  : 'micromodelv2/Publisher1/Publish3'
//  '<S17>'  : 'micromodelv2/Subscribe/Enabled Subsystem'
//  '<S18>'  : 'micromodelv2/Subscribe2/Enabled Subsystem'
//  '<S19>'  : 'micromodelv2/Subscribe3/Enabled Subsystem'
