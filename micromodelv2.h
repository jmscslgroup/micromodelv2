...
struct DW_micromodelv2_T {
  ...
  real_T time_avg_target[1280];        // '<Root>/noclosing_0804'
  real_T t_length;                     // '<Root>/noclosing_0804'
  boolean_T time_avg_target_not_empty; // '<Root>/noclosing_0804'
...
//  '<S14>'  : 'micromodelv2/noclosing_0804'
